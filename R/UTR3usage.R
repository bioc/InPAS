...
#' 
#' calculate the usage of long and short forms of UTR3 for the 
#' results of [CPsites()]
#'
#' @param CPsites outputs of [CPsites()]
#' @param coverage coverage for each sample, outputs of [coverageFromBedGraph()]
#' @param hugeData is this dataset consume too much memory? 
...
#' @param phmm logical(1), should data be prepared for singleSample 
