...
#' @param tmpfolder temp folder could save and reload the analysis 
#' data for resume analysis
#' @param silence logical(1), indicating whether progress is reported or not. 
#' By default, FALSE
#'
#' @return a data frame
