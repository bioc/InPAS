...
#' @param groupList the list of sample tag names
#'
#' @return an object of [GenomicRanges::GRanges-class] with
#' metadata: \item{dat}{matrix, first column is the fit data, the 
#' other columns are coverage data for each sample} 
